# Jessica — Content Asset Pack (No-Contact Wedge)

Instantiation of `docs/playbooks/templates/template--content-asset-pack.md`. The concrete,
copy-paste layer for the Jessica Host channel. Week-1 copy is drafted to publish-ready.

**Guardrails (non-negotiable):** empathy-first; no medical or therapeutic claims; no promises
about the relationship or the user's emotions; no "behavioral blockchain"/Fury/real-money
framing; fixed CTA set only. All copy needs human approval before posting (REGE checkpoint #1).
Any user proof needs consent (checkpoint #3).
...
- "You didn't lose them today. You're just feeling it again today. Those are different."
...
- **Sections:** (1) Why the urge peaks and passes · (2) The 4 triggers + a move for each ·
...
## 3. Creator / Intermediary Outreach (first 20 targets)

Use `docs/playbooks/templates/template--creator-outreach.md`. Target archetypes for the Wedge:
breakup-recovery creators, attachment-style educators, sober-curious creators, therapy/coach
...
## 4. Week-1 Publish-Ready Batch (final copy)
...
> don't feed it — it passes. Every time you ride one out, the next one is a little smaller.
>
> You're not weak for feeling it. You're human for surviving it.
>
...
> that hour. Inside: why the urge peaks and passes, the 4 triggers nobody warns you about, and
> an hour-by-hour plan for the first weekend.
>
> [Get the guide]
>
> Over the next few days I'll send one short email per trigger. And if you want an actual
> accountability layer for this — not just willpower — I'm opening a small private beta soon.
...
> 4/ Timer. Water. Text a friend instead. Anything but their name.
...
> wrong — because the brain rewards the check, then charges you interest at midnight.
>
> Try this: when you reach for it, name the feeling out loud first. "I miss them." Then put the
...
> ISN'T: a therapy replacement, a magic fix, or open to everyone right now.
...
> admitting a small first group so it actually feels like a room — founder check-ins, a weekly
> prompt, and people who get it. If that's what you want for your no-contact, [Join the Private
...
> check-in, and people on the same path. I'm keeping it small so it stays real.
>
...
> — checking your own progress more than their profile (good)
>
> If you made it a week, you didn't "get lucky." You rode out every urge that came. That's the
> whole skill. Keep going.

---

## 5. Reusable post skeletons (for weeks 2–4)

- **The list:** hook → 3–5 items → 1-line turn → soft CTA. (e.g., "4 relapse triggers".)
- **The micro-story:** scene → tension → small realization → universal takeaway.
- **The reframe:** common belief ("no contact = no feelings") → why it fails → better frame → CTA.
- **The receipt (Styx):** consented milestone card → what it means → Apply for Beta.
